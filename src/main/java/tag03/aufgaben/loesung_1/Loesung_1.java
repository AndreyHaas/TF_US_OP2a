/* Sie sind der größte Pizza-Hersteller auf dem Mars. Nun wollen Sie auch auf der Venus eine Fabrik eröffnen. Damit Sie nicht die Software für die Produktion und Verwaltung neu erstellen müssen, wollen Sie bestehenden Code wiederverwenden. Sie entscheiden sich, das Factory-Muster anzuwenden.
 *
 * Dafür benötigen Sie eine abstrakte Pizza-Klasse und eine abstrakte Fabrik-Klasse.
 *  Die abstrakte Fabrik stellt die abstrakte Methode erstellePizza bereit, welche die Sorte als String übergeben bekommt und das erstellte Pizza-Objekt zurück gibt.
 ...
 *      In der überschriebenen erstellePizza-Methode wird die Sorte geprüft und daraufhin das passende Pizza-Objekt erstellt und zurück gegeben.
